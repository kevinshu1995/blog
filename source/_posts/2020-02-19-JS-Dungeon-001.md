...
第一篇技術文章就交給 JS 地下城了，六角學院出的 JS 地下城真讚，根據現成的設計稿與指定的技術來練習 JS ，之後就先以地下城作為主軸來寫文章吧。
...
> ![UI設計稿](https://i.imgur.com/Yca2VDs.png)
...
![思考流程](https://i.imgur.com/puQyqle.png)
...
![建立第一區塊的迴圈](https://i.imgur.com/VWPgFlN.png)
...
![建立內部數字迴圈](https://i.imgur.com/MK5KAnk.png)
